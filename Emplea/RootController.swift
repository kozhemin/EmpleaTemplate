...
class RootViewController: UIViewController {
    ...
    lazy var topImage: UIImageView = {
        ...
        img.autoSetDimension(.width, toSize: 370.0)
        img.autoSetDimension(.height, toSize: 400.0)
    ...
    private func setupConstraints() {
        scrollView.autoPinEdgesToSuperviewEdges(with: UIEdgeInsets(top: 60.0, left: 0, bottom: 0, right: 0))
        ...
        titleLabelDefault.autoPinEdge(toSuperviewEdge: .left, withInset: 30.0)
        titleLabelDefault.autoPinEdge(toSuperviewEdge: .right, withInset: 8.0)
        titleLabelDefault.autoPinEdge(.top, to: .bottom, of: topImage, withOffset: 30.0)
        ...
        bottomBtn.autoPinEdge(toSuperviewEdge: .left, withInset: 30.0)
        bottomBtn.autoPinEdge(.top, to: .bottom, of: descriptionLabel, withOffset: 30.0)
